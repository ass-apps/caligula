<template>
	...
	<div id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed page-loading">
		<!--begin::Main-->
		<!--begin::Header Mobile-->
					...
					<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<ul class="menu-nav">
								...
								<li class="menu-item" aria-haspopup="true">
									<NuxtLink :to="{ path: '/sizes'}" class="menu-link">
										<fa icon="tags" class="mr-1"></fa>
										<span class="menu-text">Tamaños</span>
									</NuxtLink>
								</li>

								<li class="menu-item" aria-haspopup="true">
									<NuxtLink :to="{ path: '/categories'}" class="menu-link">
										<fa icon="tags" class="mr-1"></fa>
								...
								<li class="menu-item" aria-haspopup="true">
									<NuxtLink :to="{ path: '/brands'}" class="menu-link">
										<fa :icon="['fa', 'bookmark']" class="mr-1"></fa>
										<span class="menu-text">Marca</span>
									</NuxtLink>
								</li>

								<li class="menu-item" aria-haspopup="true">
									<NuxtLink :to="{ path: '/products/list'}" class="menu-link">
										<fa icon="tshirt" class="mr-1"></fa>
								...
								<li class="menu-item" aria-haspopup="true">
									<NuxtLink :to="{ path: '/sales'}" class="menu-link">
										<fa icon="file-invoice-dollar" class="mr-1"></fa>
								...
								<div class="topbar-item">
									...
									<div id="user-options-menu" class="dropdown-menu" style="right: 0; float:right !important; left: unset; padding-left: 1rem; padding-bottom: 1rem;">
										<!--begin:Header-->
											...
											<a href="#" class="btn btn-success btn-sm font-weight-bold font-size-sm mt-2">Cerrar sesión</a>
...
<script>
	...
	export default {
		head: {
			...
			link: [
				{ rel: 'stylesheet', href: '/admin/css/style.bundle.css' }, 
			],
			script: [
				{
					src: "/admin/js/ktSettings.js",
					type: "text/javascript"
				},
				{
					src: "/admin/js/scripts.bundle.js",
					type: "text/javascript"
				},
				{
					src: "/admin/js/plugins.bundle.js",
					type: "text/javascript"
				},
